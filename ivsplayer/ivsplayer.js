/*
 * @Author: Mr.Miao
 * @Date:   2018-11-18 11:24:03
 * @Last Modified by:   Mr.Miao
 * @Last Modified time: 2018-11-18 11:28:40
 */
window.onload = function() {
    document.getElementById("submit").onclick = function() {
        var ajaxTitle = document.getElementById("title").value;
        var ajaxContent = document.getElementById("content").value;
